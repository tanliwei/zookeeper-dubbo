...
//				if (nodeCache.getCurrentData() == null) {//預防刪除報錯
...
//		});
			...
			System.out.println("childNodePathCache:"+childNodePathCache);
				...
				public void childEvent(CuratorFramework client, PathChildrenCacheEvent event) throws Exception {
					if (event.getType().equals(PathChildrenCacheEvent.Type.INITIALIZED)) {
						...
						if (path.equals(ADD_PATH)) {
							...
							System.out.println("子节点数据:" + new String(event.getData().getData()));//創建節點時可以不指定数据 引发NullPointerException
